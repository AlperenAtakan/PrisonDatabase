public class Prisoner {
   ...
   private byte[] image;
    ...
    public Prisoner(int prisonerID,String prisonerName, String prisonerLastName, int height, int weight, String releaseDate, String TC, int age,int gender ,int punishmenTime , byte[] image) {
